...
#SBATCH --output=/maps/projects/course_1/scratch/group2/group-project-group-2/week18-preprocessing/logs/%x_%j.out
#SBATCH --error=/maps/projects/course_1/scratch/group2/group-project-group-2/week18-preprocessing/logs/%x_%j.err
#SBATCH --ntasks=1
...
#SBATCH --mail-user=rsc270@alumni.ku.dk
